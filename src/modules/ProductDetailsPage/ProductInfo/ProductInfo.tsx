    ...
    <div className={styles.productInfo_container}>
      {selectedProduct.description?.length > 0 && (
        <section className={styles.productInfo_aboutContainer}>
          <h3 className={styles.productInfo_title}>{t('about')}</h3>
          <ul className={styles.productInfo_aboutContainer_list}>
            {selectedProduct.description.map((describe, index) => (
              ...
              >
                ...
                {describe.text &&
                  Array.isArray(describe.text) &&
                  describe.text.map((textId: string, i: number) => (
                    <p key={i} className={styles.productInfo_text}>
                      {t(textId)}
                    </p>
                  ))}
              </li>
      ...
      <section className={styles.productInfo_techSpecsContainer}>
        <h3 className={styles.productInfo_title}>{t('techspecs')}</h3>
        <ul className={styles.productInfo_techSpecsContainer_list}>
          {selectedProduct.screen && (
            <li className={styles.productInfo_techSpecsContainer_item}>
              <p className={styles.productInfo_text}>{t('screen')}</p>
          ...
          {selectedProduct.resolution && (
            <li className={styles.productInfo_techSpecsContainer_item}>
              <p className={styles.productInfo_text}>{t('resolution')}</p>
              <p className={styles.productInfo_details}>
                {selectedProduct.resolution}
              </p>
            </li>
          ...
          {selectedProduct.processor && (
            <li className={styles.productInfo_techSpecsContainer_item}>
              <p className={styles.productInfo_text}>{t('processor')}</p>
              <p className={styles.productInfo_details}>
                {selectedProduct.processor}
              </p>
            </li>
          ...
          {selectedProduct.ram && (
            <li className={styles.productInfo_techSpecsContainer_item}>
              <p className={styles.productInfo_text}>{t('ram')}</p>
              <p className={styles.productInfo_details}>
                {selectedProduct.ram}
              </p>
            </li>
          ...
          {selectedProduct.capacity && (
            <li className={styles.productInfo_techSpecsContainer_item}>
              <p className={styles.productInfo_text}>{t('builtinmemory')}</p>
              <p className={styles.productInfo_details}>
                {selectedProduct.capacity}
              </p>
            </li>
          ...
          {selectedProduct.camera && (
            <li className={styles.productInfo_techSpecsContainer_item}>
              <p className={styles.productInfo_text}>{t('camera')}</p>
              <p className={styles.productInfo_details}>
                {selectedProduct.camera}
              </p>
            </li>
          ...
          {selectedProduct.zoom && (
            <li className={styles.productInfo_techSpecsContainer_item}>
              <p className={styles.productInfo_text}>{t('zoom')}</p>
              <p className={styles.productInfo_details}>
                {selectedProduct.zoom}
              </p>
            </li>
          ...
          {selectedProduct.cell?.length > 0 && (
            <li className={styles.productInfo_techSpecsContainer_item}>
              <p className={styles.productInfo_text}>{t('cell')}</p>
              <p className={styles.productInfo_details}>
