...
export const ProductOverview: React.FC<Props> = ({
  ...
  const findId = products.find(
    (product: { itemId: string | undefined }) =>
  ...
  return (
    <div className={styles.overview}>
      <h2 className={styles.overview_title}>{t(selectedProduct.name)}</h2>
        ...
        <div className={styles.overview_optionsContainer}>
          <div className={styles.overview_colorsIdBlock}>
            ...
            <div className={styles.overview_colorsIdBlock_colors}>
              <p className={styles.overview_text}>{t('avilablecolors')}</p>
          ...
          <div className={styles.overview_capacityContainer}>
            <p className={styles.overview_text}>{t('selectcapacity')}</p>
          ...
          <div className={styles.overview_descriptionContainer}>
            <div className={styles.overview_row}>
              <p className={styles.overview_text}>{t('screen')}</p>
            ...
            <div className={styles.overview_row}>
              <p className={styles.overview_text}>{t('resolution')}</p>
              <p className={styles.overview_text_value}>
            ...
            <div className={styles.overview_row}>
              <p className={styles.overview_text}>{t('processor')}</p>
              <p className={styles.overview_text_value}>
            ...
            <div className={styles.overview_row}>
              <p className={styles.overview_text}>{t('ram')}</p>
              <p className={styles.overview_text_value}>
                {selectedProduct.ram}
              </p>
            </div>
