...
export const ProductCard: React.FC<Props> = ({
  ...
  const isInCart = cartProducts.some(
    (product: { itemId: string }) => product.itemId === itemId,
  );
  ...
  return (
    <div className={classNames(styles.phones_card, className)}>
      <img
        ...
        onClick={onClick}
      />
      <p className={styles.phones_title}>{t(name)}</p>
      ...
      <div className={styles.phones_options}>
        ...
        <p className={styles.phones_option}>
          {t('capacity_phone')}{' '}
          <span className={styles.phones_details}>{capacity}</span>
        </p>
        <p className={styles.phones_option}>
          {t('ram')} <span className={styles.phones_details}>{ram}</span>
        </p>
      </div>
